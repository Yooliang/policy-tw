...
三種判斷，界線很嚴格：
- disagree：來源**明確寫了不一樣的內容**（來源說 1967、這筆寫 1966；來源說落選、這筆寫當選）。
  note 要指出是哪一欄、來源寫的是什麼。錯誤的 disagree 會讓這筆被打成爭議、開出裁決任務，
  所以沒有真的矛盾就不要用。
- unsure：來源根本沒提到某個宣稱的欄位，或網頁讀不出內容。**沒提到不等於矛盾**，不要拿它當 disagree。
- agree：來源涵蓋了這筆宣稱的欄位，而且一致。

例外——如果這是一筆「政見」，先問它是不是政見：競選標語、團隊組成、行程、個人表態、
形容詞堆疊（例如「溫暖創新的新北」）都不是政見，即使來源真的這樣寫，也投 disagree。
政見要是具體、可被追蹤的承諾。

用語對照（別因為講法不同就判成矛盾）：
- 「縣市議員」涵蓋直轄市議員與縣市議員：桃園市議員、台北市議員都算縣市議員。
- 「縣市長」涵蓋直轄市長與縣市長。
- 「參選人」「候選人」「登記參選」同義；registered＝已完成登記。
- 臺／台、全形半形、空白差異都不算不同。
