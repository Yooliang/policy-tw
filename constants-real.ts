...
export const CANDIDATES: Candidate[] = [
  ...
  // NEW: Indigenous District Chief and Rep (Wulai, New Taipei)
  {
    id: 'c14_wulai_chief',
    name: '林山水',
    party: PoliticalParty.IND,
...
export const POLICIES: Policy[] = [
  // 歷史政見 (前任) - 用於連結
  {
    ...
    relatedPolicyIds: ['p5'] // 連結到陳其邁的 S 廊帶
  },
  ...
  // New Policies for Hsinchu County Stack (竹北生活圈)
  {
    id: 'p_hc_mayor_1',
    candidateId: 'c10_hc_mayor', // 縣長
    title: '大新竹輕軌藍線延伸竹北',
  ...
  {
    id: 'p_hc_tm_1',
    candidateId: 'c11_hc_town_mayor', // 竹北市長
    title: '配合輕軌規劃站點接駁車',
  ...
  // Wulai Indigenous District Policies
  {
    id: 'p_wulai_chief_1',
    candidateId: 'c14_wulai_chief',
    title: '烏來溫泉觀光升級計畫',
