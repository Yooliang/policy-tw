-- 建立 upsert_politician 函式：同名+同出生年視為同一人
...
BEGIN
  ...
  ELSE
    ...
    VALUES (p_name, p_party, p_status, p_election_type, p_position, p_region, p_sub_region, p_village, p_birth_year, p_education_level)
